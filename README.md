...
|---|---:|---|
| 🌾 กรมส่งเสริมการเกษตร (DOAE) | 15 | [`graphs/กรมส่งเสริมการเกษตร/`](graphs/กรมส่งเสริมการเกษตร/README.md) |
...
> ⚠️ ไฟล์ `.html` ต้อง **ต่ออินเทอร์เน็ต** ตอนเปิด (โหลด plotly.js จาก CDN)
> และ GitHub ไม่เรนเดอร์ HTML ในหน้า preview — ให้ดาวน์โหลดไปเปิดในเบราว์เซอร์
> ส่วนไฟล์ `.png` ดูบน GitHub ได้ทันที
